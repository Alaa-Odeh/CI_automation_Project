...
class OAuth1Session(requests.Session):
    ...
    in the OAuth workflows through convenience methods to prepare authorization
    URLs and parse the various token and redirection responses. It also provide
    rudimentary validation of responses.

    An example of the OAuth workflows using a basic CLI app and Twitter.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param resource_owner_key: A resource owner key, also referred to as
                                   ...
                                   when in the workflows it is used.
    ...
    def authorization_url(self, url, request_token=None, **kwargs):
        ...
        This is the second step in the OAuth 1 workflows. The user should be
    ...
    def fetch_request_token(self, url, realm=None, **request_kwargs):
        ...
        This is the first step in the OAuth 1 workflows. A request token is
    ...
    def fetch_access_token(self, url, verifier=None, **request_kwargs):
        ...
        This is the final step in the OAuth 1 workflows. An access token is
